...
sealed trait AlignmentType extends Enum.Value[AlignmentType]
...
sealed trait SeparatorSuppressionPolicy extends Enum.Value[SeparatorSuppressionPolicy]
 ...
 */
sealed trait EmptyElementParsePolicy extends Enum.Value[EmptyElementParsePolicy]
