...
trait HasSetDebugger {
  ...
  /**
   * dbg is AnyRef since the type of the debugger is specific to a particular implementation of DFDL.
   *
   * Implementations of this mixin should cast this parameter down to the kind of debugger they expect.
   */
