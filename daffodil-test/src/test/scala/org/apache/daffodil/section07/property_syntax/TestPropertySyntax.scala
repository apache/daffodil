...
class TestPropertySyntax extends TdmlTests {
  ...
  // DFDL-2798
  @Test def ignoredPropertiesWarning2 = test
  @Test def propertiesOnTypeOfElement1 = test
  @Test def propertiesOnTypeOfElement2 = test
  @Test def propertiesOnGroups1 = test
