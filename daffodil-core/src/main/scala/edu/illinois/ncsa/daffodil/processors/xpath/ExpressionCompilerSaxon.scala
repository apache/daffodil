...
//          case ConvertToType.UnsignedByte => new ConstantExpression(compileTimeConvertToUnsignedByte(s))
//          case ConvertToType.Short => new ConstantExpression(compileTimeConvertToShort(s))
//          case ConvertToType.UnsignedShort => new ConstantExpression(compileTimeConvertToUnsignedShort(s))
//          case ConvertToType.Int => new ConstantExpression(compileTimeConvertToInt(s))
//          case ConvertToType.UnsignedInt => new ConstantExpression(compileTimeConvertToUnsignedInt(s))
//          case ConvertToType.Long => new ConstantExpression(compileTimeConvertToLong(s))
//          case ConvertToType.UnsignedLong => new ConstantExpression(compileTimeConvertToUnsignedLong(s))
...
//          case ConvertToType.UnsignedInteger => new ConstantExpression(compileTimeConvertToNonNegativeInteger(s))
