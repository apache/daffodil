...
//      Nope
//    else {
//      val pfci = possibleFirstChildInsertables
//      val plci = possibleLastChildInsertables
//      if (pfci.isEmpty && plci.isEmpty)
//        Nope
//      else {
//        val childPairs = pfci.flatMap { insertable =>
//          val augmenter = insertable.siblingAugmenter
//          val pairs = insertable.siblingIndicators.map { ind => // Note: siblingIndicators: yes. We're looking for its laterSiblings here
//            (ind.namedQName, augmenter)
//          }
//          pairs
//        }
//        val anchorName = namedQName
//        val endOfParentAugmenterPairs = plci.map { insertable =>
