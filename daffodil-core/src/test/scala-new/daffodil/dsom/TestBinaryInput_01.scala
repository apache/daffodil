...
class TestBinaryInput_01 extends JUnitSuite {
  ...
  @Test def testOneBit1() {
    ...
    val inStream = InStream.fromByteChannel(null, in, 1)
  ...
  def testBufferShortBigEndianExtraction() {
    ...
    val inStream = InStream.fromByteChannel(null, in, 2)
  ...
  def testBufferIntBigEndianExtraction() {
    ...
    val inStream = InStream.fromByteChannel(null, in, 4)
  ...
  def testBufferLongBigEndianExtraction() {
    ...
    val inStream = InStream.fromByteChannel(null, in, 8)
  ...
  def testBufferBigIntBigEndianExtraction() {
    ...
    val inStream = InStream.fromByteChannel(null, in, 32)
