        ...
        <xs:complexType>
          <xs:sequence  dfdl:separator="," >
            <xs:element name="s1" type="st" dfdl:lengthKind="delimited" 
                dfdl:textStringPadCharacter="_" dfdl:textPadKind="padChar" dfdl:textStringJustification="left" />
            <xs:element name="s2" type="st" dfdl:lengthKind="delimited" 
                dfdl:textStringPadCharacter="_" dfdl:textPadKind="padChar" dfdl:textStringJustification="right"/>
            <xs:element name="s3" type="st" dfdl:lengthKind="delimited" 
                dfdl:textStringPadCharacter="_" dfdl:textPadKind="padChar" dfdl:textStringJustification="center"/>
          </xs:sequence>
        </xs:complexType>
      </xs:element>
