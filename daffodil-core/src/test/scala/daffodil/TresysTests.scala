...
class TresysTests extends JUnit3Suite {
  ...
  val runnerNSD = new DFDLTestSuite(Misc.getRequiredResource(nsd))
  ...
  val runnerEscapeScheme = new DFDLTestSuite(Misc.getRequiredResource(escapeScheme))
...
//  def test_AB009() { runnerAB9.runOneTest("AB009") }
  ...
  val runnerCH= new DFDLTestSuite(Misc.getRequiredResource(ch))
  ...
  val runnerSQ = new DFDLTestSuite(Misc.getRequiredResource(sq))
  def test_seq1() { runnerSQ.runOneTest("seq1")}
  
  val ln = testDir + "literal-value-nils.tdml"
  val runnerLN = new DFDLTestSuite(Misc.getRequiredResource(ln))
  ...
  val runnerAQ = new DFDLTestSuite(Misc.getRequiredResource(aq))

  def test_AQ000() { runnerAQ.runOneTest("AQ000") }

  
  val runnerEX = new DFDLTestSuite(Misc.getRequiredResource(testDir + "expressions.tdml"))
  ...
  val runnerAR = new DFDLTestSuite(Misc.getRequiredResource(ar))
