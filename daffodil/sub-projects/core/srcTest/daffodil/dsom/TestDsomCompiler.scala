...
class TestDsomCompiler extends JUnit3Suite {
  ...
  def test_escapeSchemeRef = {
    val testSchema = TestUtils.dfdlTestSchema(
      <dfdl:format separator="" initiator="" terminator="" emptyValueDelimiterPolicy="none" textNumberRep="standard" representation="text" occursStopValue="-1" occursCountKind="expression"/>
      ...
      <xs:element name="list">
        <xs:complexType>
          <xs:sequence>
            <xs:element name="character" type="xsd:string" maxOccurs="unbounded" dfdl:representation="text" dfdl:separator="," dfdl:terminator="%NL;" dfdl:escapeSchemeRef="pound"/>
    ...
    val Seq(e1: ElementBase, e2: ElementBase) = seq.groupMembers
    val e1f = e1.formatAnnotation.asInstanceOf[DFDLElement]
    val props1 = e1.localAndFormatRefProperties
    assertTrue(FindValue(props1, "escapeKind", "escapeCharacter"))
    assertTrue(FindValue(props1, "escapeCharacter", "#"))

    assertEquals(e1f.escapeCharacterRaw, "#")

    val e2f = e2.formatAnnotation.asInstanceOf[DFDLElement]
    val props2 = e2.localAndFormatRefProperties
    assertTrue(FindValue(props2, "escapeKind", "escapeBlock"))
    assertTrue(FindValue(props2, "escapeBlockStart", "/*"))
    assertTrue(FindValue(props2, "escapeBlockEnd", "*/"))

//    assertEquals(e2f.escapeBlockStartRaw, "/*")
//    assertEquals(e2f.escapeBlockEndRaw, "*/")
  }

  def test_escapeSchemeRef2 = {
    val testSchema = TestUtils.dfdlTestSchema(
      <dfdl:format separator="" initiator="" terminator="" emptyValueDelimiterPolicy="none" textNumberRep="standard" representation="text" occursStopValue="-1" occursCountKind="expression"/>
      <dfdl:defineEscapeScheme name="base">
        <dfdl:escapeScheme escapeSchemeRef="pound"/>
      </dfdl:defineEscapeScheme>
      <dfdl:defineEscapeScheme name="pound">
        <dfdl:escapeScheme escapeCharacter='#' escapeKind="escapeCharacter"/>
      </dfdl:defineEscapeScheme>
      ...
      <xs:element name="list">
        <xs:complexType>
          <xs:sequence>
            <xs:element name="character" type="xsd:string" maxOccurs="unbounded" dfdl:representation="text" dfdl:separator="," dfdl:terminator="%NL;" dfdl:escapeSchemeRef="base"/>
            <xs:element name="block" type="xsd:string" maxOccurs="unbounded" dfdl:representation="text" dfdl:separator="," dfdl:terminator="%NL;" dfdl:escapeSchemeRef="cStyleComment"/>
          </xs:sequence>
        </xs:complexType>
      </xs:element>)
    ...
    val Seq(e1: ElementBase, e2: ElementBase) = seq.groupMembers
    val e1f = e1.formatAnnotation.asInstanceOf[DFDLElement]
    val props = e1.localAndFormatRefProperties
    assertTrue(FindValue(props, "escapeKind", "escapeCharacter"))
    assertTrue(FindValue(props, "escapeCharacter", "#"))
    println(props)
  }
