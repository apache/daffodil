...
class TestDelimSearcherV3 extends JUnit3Suite {
  ...
  def testSingleSeparatorChar = {
    ...
    val (state1, result1, endPos1, endPosDelim1) = ds.search2(cb)
    assertEquals(ds.SearchResult.FullMatch, state1)
    assertEquals("abc", result1)
    assertEquals(3, endPos1)
    
    // Round 2 - Expect: EOF, def, 6
    val (state1a, result1a, endPos1a, endPosDelim1a) = ds.search2(cb, endPos1 + 1)
    ...
    // Round 1 - Expect: FullMatch, abc, 3
    val (state2, result2, endPos2, endPosDelim2) = ds.search2(cb)
    ...
    val (state2a, result2a, endPos2a, endPosDelim2a) = ds.search2(cb, endPos2 + 1)
    assertEquals(ds.SearchResult.FullMatch, state2a)
    assertEquals("def", result2a)
    assertEquals(7, endPos2a)
    
    // Round 3 - Expect: EOF, EMPTY, 7
    val (state2b, result2b, endPos2b, endPosDelim2b) = ds.search2(cb, endPos2a + 1)
    ...
    val (state4, result4, endPos4, endPosDelim4) = ds.search2(cb)
    ...
    val (state4a, result4a, endPos4a, endPosDelim4a) = ds.search2(cb, endPos4 + 1)
    assertEquals(ds.SearchResult.FullMatch, state4a)
    assertEquals("", result4a)
    assertEquals(4, endPos4a)
    
    // Round 3 - Expect: EOF, def, 7
    val (state4b, result4b, endPos4b, endPosDelim4b) = ds.search2(cb, endPos4a + 1)
  ...
  def testSingleSeparatorCharClassWSP_Plus = {
    ...
    val (state4a, result4a, endPos4a, endPosDelim4a) = ds.search2(cb, endPosDelim4 + 1)
  ...
  def testSingleSeparatorCharClassWSP_Star = {
    ...
    val (state5, result5, endPos5, endPosDelim5) = ds.search2(cb)
  ...
  def testMultipleSeparatorsDifferent = {
    ...
    val (state1b, result1b, endPos1b, endPosDelim1b) = ds.search2(cb, endPos1a + 1)
    ...
    val (state2c, result2c, endPos2c, endPosDelim2c) = ds.search2(cb, endPos2b + 1)
    ds.printMatchStruct
    ...
    val (state2d, result2d, endPos2d, endPosDelim2d) = ds.search2(cb, endPos2c + 1)
    ds.printMatchStruct
  ...
  def testMultipleCharacterDelimiters = {
    ...
    val (state1a, result1a, endPos1a, endPosDelim1a) = ds.search2(cb, endPos1 + 3)
    assertEquals(ds.SearchResult.FullMatch, state1a)
    assertEquals("def", result1a)
    assertEquals(9, endPos1a)
    
    // Round 3 - Expect: EOF, efgh, 15
    val (state1b, result1b, endPos1b, endPosDelim1b) = ds.search2(cb, endPos1a + 3)
    assertEquals(ds.SearchResult.EOF, state1b)
    assertEquals("efgh", result1b)
  ...
  def testLongestMatch = {
    ...
    val (state1a, result1a, endPos1a, endPosDelim1a) = ds.search2(cb, endPosDelim1 + 1)
    assertEquals(ds.SearchResult.EOF, state1a)
    assertEquals("def", result1a)
