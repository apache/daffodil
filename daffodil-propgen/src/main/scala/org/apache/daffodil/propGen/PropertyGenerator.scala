...
class PropertyGenerator(arg: Node) {
  ...
  val excludedTypes = List("TextNumberBase", "AlignmentType", "FillByteType", "BinaryBooleanTrueRepType", "BinaryBooleanFalseRepType",
    "SeparatorSuppressionPolicy", "dafint:daffodilAG", "TextStandardExponentRep", // Do these by hand.
  ...
  val excludedAttributes = List("TextNumberBase",
    "SeparatorSuppressionPolicy", "TextStandardExponentRep" ) // Do these by hand.
  ...
  def genAttributeGroup(ag: Node): String = {
    ...
    val attrNamesTypes = nonEnumAttributeList.flatMap(attrNode => {
      ...
      val excludedBecauseDoneByHand = List("separatorSuppressionPolicy", "separatorPolicy", "textStandardExponentRep", "textStandardExponentCharacter")
