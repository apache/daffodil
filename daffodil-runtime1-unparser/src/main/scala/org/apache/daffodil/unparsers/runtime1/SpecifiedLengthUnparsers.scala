...
final class SpecifiedLengthExplicitImplicitUnparser(
  ...
  override lazy val childProcessors: Vector[Unparser] = Vector(eUnparser)
...
class SpecifiedLengthPrefixedUnparser(
  ...
  override lazy val childProcessors: Vector[Unparser] = Vector(prefixedLengthUnparser, eUnparser)
