...
//import edu.illinois.ncsa.daffodil.util.CursorFromIterator
//
///**
// * THIS CANNOT WORK. YOU CANNOT EVALUATE EXPRESSIONS UNLESS YOU HAVE THE WHOLE UNPARSE TREE-WALK BECAUSE YOU MUST EVALUATE EXPRESSIONS
// * FOR COMPUTED ELEMENTS, AND THOSE CAN CALL dfdl:valueLength or dfdl:contentLength AND THOSE REQUIRE THE ACTUAL UNPARSING.
// *
// * ONE COULD PUT IN DEFAULTS, BUT DOING THIS WHOLE PASS JUST TO DO THAT IS SILLY.
// *
// *
// *
...
//  }
//
//  val subCursor = new CursorFromIterator(this, advanceAccessor, inspectAccessor)
//  override def advance: Boolean = subCursor.advance
//  override def inspect: Boolean = subCursor.inspect
//
//  /**
...
//  private val augmentedIterator = new IteratorWithPeekImpl(initialUnaugmentedSource.toIteratorWithPeek, addedEvents)
//
//  /**
