...
public interface LayerCompileInfo {
  ...
  /**
   * Obtains the LayerVariable object that can be used to access the variable at runtime.
   *
   * @param namespaceURI namespace of the variable. Use empty string ("") for no-namespace.
   * @param varName the name of the variable
   * @return the LayerVariable
   */
  LayerVariable layerVariable(String namespaceURI, String varName);
