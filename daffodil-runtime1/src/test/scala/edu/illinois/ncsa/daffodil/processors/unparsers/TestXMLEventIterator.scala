...
//
//  def sourceToReader(source: Source, advanceAccessor: XMLAccessor, inspectAccessor: XMLAccessor) = {
//    val cursor = new XMLEventCursorFromInput(source, advanceAccessor, inspectAccessor)
//    //
...
//    //
//    val list = cursor.toStream.toList.map { _.event }
...
//    val inspectAccessor = new XMLAccessor
//    val reader = sourceToReader(source, advanceAccessor, inspectAccessor)
//
//    val iterator = new XMLInfosetEventIterator(null)
...
//    val p = new XMLInfosetEventIterator(null).isNil(e.attributes, e.scope)
//    assertTrue(p)
//  }
//
//  @Test def testIsNil2() {
...
//    val inspectAccessor = new XMLAccessor
//    val cursor = new XMLEventCursorFromInput(source, advanceAccessor, inspectAccessor)
//    val iterator = new XMLInfosetEventIterator(cursor)
